...
export default function Solution() {
  ...
  />
        ...
        <p className="text-lg text-blue-100 text-center max-w-3xl mx-auto mt-6">
          Diagnuvo ED™ transforms the chaos of the emergency department into a streamlined, predictable environment.
          By combining intelligent workflow automation with AI-assisted patient analysis, we empower clinicians to make
          faster, safer, and more accurate decisions when every second matters.
        </p>

        <div className="grid md:grid-cols-3 gap-10 mt-16 text-center">
          <div className="bg-white/5 border border-white/10 rounded-xl p-8 backdrop-blur-md hover:border-cyan-400/40 transition-all">
            <div className="text-5xl font-bold text-cyan-400">↓ 40%</div>
            <p className="mt-4 text-white font-semibold">Cognitive Load</p>
            <p className="text-blue-100 text-sm mt-2">Reduced mental burden for clinicians</p>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-xl p-8 backdrop-blur-md hover:border-cyan-400/40 transition-all">
            <div className="text-5xl font-bold text-cyan-400">↑ 65%</div>
            <p className="mt-4 text-white font-semibold">Speed to Decision</p>
            <p className="text-blue-100 text-sm mt-2">Faster clinical escalation and action</p>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-xl p-8 backdrop-blur-md hover:border-cyan-400/40 transition-all">
            <div className="text-3xl font-bold text-cyan-400">Audit-Ready</div>
            <p className="mt-4 text-white font-semibold">by Design</p>
            <p className="text-blue-100 text-sm mt-2">Immutable clinical audit trails</p>
          </div>
        </div>
      </div>
    </section>
